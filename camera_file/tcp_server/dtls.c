...
int dtls(struct pthread_arguments* p_a) {
	...
	if (ret == -1) 
	{
		printf("Error with try_connection\n");
...
static int aes_cm_encrypt_rtp(struct crypto_context *c, unsigned char* buf) {
	//return aes_cm_encrypt(c, r->ssrc, s, idx);
	printf("aes_cm_encrypt_rtp\n");
}

/* rfc 3711 sections 3.4 and 4.1 */
static int aes_cm_encrypt_rtcp(struct crypto_context *c, unsigned char* buf) {
	//return aes_cm_encrypt(c, r->ssrc, s, idx);
...
static int aes_cm_session_key_init(struct crypto_context *c) {
	...
	*/
	printf("aes_cm_session_key_init\n");
	return 0;
}
...
static int aes_f8_session_key_init(struct crypto_context *c) {
	...
	*/
	printf("aes_f8_session_key_init\n");
	return 0;
}
static int evp_session_key_cleanup(struct crypto_context *c) {
	...
	*/
	printf("evp_session_key_cleanup\n");
	return 0;
}
